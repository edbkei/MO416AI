...
class CornersProblem2(search2.SearchProblem2):
    """
...
class AStarCornersAgent2(Search2Agent):
    ...
    def __init__(self):
        ...
        self.searchType = CornersProblem2
...
class ClosestDotSearchAgent2(Search2Agent):
        ...
        while(currentState.getFood().count() > 0):
            ...
            for action in nextPathSegment:
                ...
                if action not in legal:
                    ...
                    raise Exception('findPathToClosestDot returned an illegal move: '+ t)
    ...
    def findPathToClosestDot(self, gameState):
        ...
        problem = AnyFoodSearchProblem2(gameState)

        "*** YOUR CODE HERE ***"
        util.raiseNotDefined()

class AnyFoodSearchProblem2(PositionSearchProblem2):
    """
...
def mazeDistance(point1, point2, gameState):
    ...
    prob = PositionSearchProblem2(gameState, start=point1, goal=point2, warn=False, visualize=False)
    return len(search2.bfs(prob))
